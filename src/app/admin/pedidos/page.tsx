...
export default function PedidosPage() {
  ...
  return (
    <div className="flex h-full gap-5">
      {/* Left Column */}
      <div className={`transition-all duration-300 ${selectedOrder ? 'max-w-4xl' : 'flex-1'}`}>
      ...
      {selectedOrder && (
        <div className="w-96 bg-white rounded-2xl border border-[#c8c8c8] overflow-hidden shadow-lg">
          <OrderDetailPanel
            isOpen={true}
            order={selectedOrder}
