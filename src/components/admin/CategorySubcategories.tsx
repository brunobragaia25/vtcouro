      ...
      {expanded && (
        <div className="mt-3 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 border border-dashed border-gray-300 rounded-lg text-sm text-gray-500 hover:border-leather-400 hover:text-leather-700 transition-colors"
          >
            <Plus size={16} />
            Nova subcategoria
          </button>
